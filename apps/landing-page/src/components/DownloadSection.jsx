    ...
    return (
        <section id="download" className="bg-primary-50 px-6 md:px-16 py-16 overflow-hidden">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
                <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="flex-1 text-center md:text-left">
                ...
                <motion.div initial={{ opacity: 0, y: 100 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="flex-1 relative">
                    <div className="relative z-10 w-[280px] md:w-[320px] mx-auto aspect-[9/19] bg-gray-900 rounded-[3rem] border-[8px] border-gray-800 shadow-2xl overflow-hidden">
                        <img src={android2} alt="App Screenshot" className="w-full h-full object-cover" />
                    </div>
                    {/* Decorative blobs */}
