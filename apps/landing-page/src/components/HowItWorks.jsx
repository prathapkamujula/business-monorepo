        ...
        <section id="how-it-works" className="px-6 md:px-16 py-16 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {steps.map((s, i) => (
                    ...
                    >
                        <div className="text-6xl font-serif font-black text-primary-50/50 absolute top-6 right-8 group-hover:text-primary-100 transition-colors">{s.num}</div>
                        <div className="w-16 h-16 rounded-2xl bg-primary-50 flex items-center justify-center text-3xl mb-8 text-primary-500">{icons[i]}</div>
